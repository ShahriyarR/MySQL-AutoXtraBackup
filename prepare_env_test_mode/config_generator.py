            ...
            for conf_file in conf_list:
                ...
                if not os.path.isfile(conf_path):
                    with open(conf_path, 'w') as cfgfile:
                        ...
                        if conf_file == 'xb_2_4.conf':
                            config.set(section2, "backup_tool", "{}/target/percona-xtrabackup-2.4.x-debug/bin/xtrabackup".format(self.testpath))
                        else:
                            config.set(section2, "backup_tool", "{}/target/percona-xtrabackup-2.3.x-debug/bin/xtrabackup".format(self.testpath))
                        ...
                        if conf_file == 'xb_2_4.conf':
                            config.set(section4, "#xbcrypt", "{}/target/percona-xtrabackup-2.4.x-debug/bin/xbcrypt".format(self.testpath))
                        else:
                            config.set(section4, "#xbcrypt", "{}/target/percona-xtrabackup-2.3.x-debug/bin/xbcrypt".format(self.testpath))
                        ...
                        if conf_file == 'xb_2_4.conf':
                            config.set(section5, "#xbstream", "{}/target/percona-xtrabackup-2.4.x-debug/bin/xbstream".format(self.testpath))
                        else:
                            config.set(section5, "#xbstream",
                                       "{}/target/percona-xtrabackup-2.3.x-debug/bin/xbstream".format(self.testpath))
                        ...
                        config.set(section8, "xb_configs", "xb_2_4.conf xb_2_3.conf")
