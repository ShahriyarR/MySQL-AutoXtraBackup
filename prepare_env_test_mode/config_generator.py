                            ...
                            with open(conf_path, 'w') as cfgfile:
                                ...
                                if '2_4' in conf_file:
                                    config.set(section2, "backup_tool",
                                               "{}/target/percona-xtrabackup-2.4.x-debug/bin/xtrabackup".format(self.testpath))
                                else:
                                    config.set(section2, "backup_tool",
                                               "{}/target/percona-xtrabackup-2.3.x-debug/bin/xtrabackup".format(self.testpath))
                                ...
                                if '2_4' in conf_file:
                                    config.set(section4, "#xbcrypt",
                                               "{}/target/percona-xtrabackup-2.4.x-debug/bin/xbcrypt".format(self.testpath))
                                else:
                                    config.set(section4, "#xbcrypt",
                                               "{}/target/percona-xtrabackup-2.3.x-debug/bin/xbcrypt".format(self.testpath))
                                ...
                                if '2_4' in conf_file:
                                    config.set(section5, "#xbstream",
                                               "{}/target/percona-xtrabackup-2.4.x-debug/bin/xbstream".format(self.testpath))
                                else:
                                    config.set(section5, "#xbstream",
