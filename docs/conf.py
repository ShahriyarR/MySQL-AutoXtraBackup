...
copyright = u'2019, Shahriyar Rzayev'
...
latex_documents = [
    (master_doc, 'MySQLAutoXtrabackup.tex', u'MySQL AutoXtrabackup Documentation',
     u'Shahriyar Rzayev', 'manual'),
]
...
man_pages = [
    (master_doc, 'mysqlautoxtrabackup', u'MySQL AutoXtrabackup Documentation',
     [author], 1)
]
